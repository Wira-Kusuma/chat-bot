...
function process() {
    ...
    botReply(understandingResponses[Math.floor(Math.random() * understandingResponses.length)]);
}
    ...
    botReply(unknownResponses[Math.floor(Math.random() * unknownResponses.length)]);
}
